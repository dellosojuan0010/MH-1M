...
pasta_saida = os.path.join("..", "..", "resultadosAMMD2", "pre_explicabilidade", f"resultado_RF_XGB_I_18092025")
...
print(f" - df_po : {df_i.shape}")


# Parte 7 - Executar o modelo e recuperar os resultados para cada DataFrame

df_resultados = pd.concat([
    avaliar_modelos_em_dataframe(df_i, 'intents', pasta_saida),
], ignore_index=True)
