...
print(f"Benigno: {len(idx_benignos)}, Malwares: {len(idx_malwares)}")
...
# === ATÉ A LINHA 37, AS INSTRUÇÕES SÀO AS MESMAS DO ARQUIVO prepara_base_agrupa_apicalls.py
...
CAMINHO_ARQUIVO_SAIDA_COLUNAS = os.path.join("..", "..", "dados", "colunas.csv")

CAMINHO_ARQUIVO_SAIDA_DADOS_TREINO = os.path.join("..", "..", "dados", "dados_treino.csv")
CAMINHO_ARQUIVO_SAIDA_CLASSES_TREINO = os.path.join("..", "..", "dados", "classes_treino.csv")

CAMINHO_ARQUIVO_SAIDA_DADOS_TESTE = os.path.join("..", "..", "dados", "dados_teste.csv")
CAMINHO_ARQUIVO_SAIDA_CLASSES_TESTE = os.path.join("..", "..", "dados", "classes_teste.csv")
